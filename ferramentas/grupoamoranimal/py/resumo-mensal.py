...
OUT_JSON = os.path.join(DIR, '..', 'json', 'instagram-grupoamoranimal-resumo-mensal.json')
PARTIAL_JSON = os.path.join(DIR, '..', 'json', 'instagram-grupoamoranimal-resumo-mensal.partial.json')
...
def main():
    ...
    if args.from_local:
        ...
        ds_file = os.path.join(DIR, '..', 'json', 'instagram-grupoamoranimal-dataset.json')
